    ...
    <div class="mx-auto">
        <div class="flex justify-end">
            <button 
                ...
                class="px-3 py-2 mr-2 text-base text-blue-600 transition duration-150 ease-in-out rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700"
            >
                Pular
            </button>
        </div>
...
<div class="container px-4 mx-auto mt-2 bg-white rounded">
    ...
    <div class="pt-2 mx-auto">
        <div class="container mx-auto">
            <form x-data="form" class="w-11/12 mx-auto mt-4 mb-4 xl:w-full xl:mx-0">
                <div class="flex flex-col mb-3 xl:w-1/4 lg:w-1/2 md:w-1/2">
                    ...
                    @foreach ($categories as $category)
                        ...
                        <template x-for="(skill, index) in payload['{{ $category['name'] }}']">
                            <div class="relative flex gap-3 mb-4 -mt-1 bg-white border rounded-md border-slate-400">
                                <div class="flex flex-col justify-center py-3 pl-3 sm:py-0">
                                ...
                                <div 
                                    ...
                                    class="inset-0 w-5 m-auto mt-3 mr-3 text-black cursor-pointer"
                                >
...
<div class="container w-11/12 px-4 mx-auto">
    <div class="flex w-full bg-white sm:px-0">
        <button 
            role="submit" 
            aria-label="Salvar" 
